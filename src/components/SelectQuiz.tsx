...
export function SelectQuiz ({ index, title, img }: Props): JSX.Element {
  ...
  return (
    <div onClick={() => handleClick(index)} className=' bg-white dark:bg-navy w-[327px] h-[64px] md:w-[640px] md:h-[80px] xl:w-[564px] xl:h[96px] rounded-xl p-[18px] flex justify-between hover:cursor-pointer items-center gap-8 border-[3px] border-white dark:border-navy hover:border-purpol dark:hover:border-purpol transition-colors'>
